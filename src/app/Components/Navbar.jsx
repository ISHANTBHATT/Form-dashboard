...
function Navbar() {
  return (
    <header className="flex bg-[#121533] py-3 px-6 sm:px-10 font-[sans-serif] min-h-[70px] tracking-wide z-50 fixed bottom-6 left-[10%] sm:left-[20%]  xl:left-[30%] shadow-2xl rounded-2xl">
      <div className="flex flex-wrap items-center justify-between gap-4 w-full">
        <div id="collapseMenu" className="">
          {/* <button
            id="toggleClose"
